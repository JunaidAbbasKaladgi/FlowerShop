            ...
            <div className='max-w-screen-2xl mt-[12vh] container mx-auto  md:px-20'>
                <div className=' md:flex'>
                    <div className='border- gap-x-10 grid grid-cols-2 ml-12 md:gap-[8vh] md:h-[40vh] w-[75%]  md:w-[35%] md:grid-cols-1'>
                        <div onClick={() => handleCategoryClick('SEASONAL FLOWERS')} className="bg-base-100 md:flex md:w-full md:flex-row md:justify-center w-[15vh] md:items-center md:gap-2 flex flex-col dark:text-black cursor-pointer rounded-xl hover:shadow-x hover:scale-20 duration-500 ">
                        ...
                        <div onClick={() => handleCategoryClick('ROSES')} className="w-[15vh] bg-base-100 md:flex md:w-full md:flex-row md:justify-center md:items-center md:gap-2  dark:text-black cursor-pointer rounded-xl hover:shadow-x hover:scale-20 duration-500 ">
                            <figure className=' md:w-1/2'>
                                <img className='md:h-[20vh] rounded-xl'
                        ...
                        <div onClick={() => handleCategoryClick('WEDDING FLOWERS')} className="bg-base-100 md:flex md:w-full md:flex-row md:justify-center md:items-center md:gap-2 w-[15vh] dark:text-black cursor-pointer rounded-xl hover:shadow-x hover:scale-20 duration-500 ">
                            <figure className='md:w-1/2'>
                                <img className='md:h-[20vh] rounded-xl'
                        ...
                        <div onClick={() => handleCategoryClick('BOUQUETS')} className="bg-base-100 md:flex md:w-full md:flex-row md:justify-center md:items-center md:gap-2 w-[15vh] dark:text-black cursor-pointer rounded-xl hover:shadow-x hover:scale-20 duration-500 ">
                            <figure className='md:w-1/2'>
                                <img className='md:h-[20vh] rounded-xl '
